...
export default function Update_old (props) {
  ...
  return (
    ...
    {/* <dialog id="modal_update" className={`modal`} open={open}> */}
      ...
      <div className={`modal-box- overflow-y-auto overscroll-contain duration-300 scale-100 w-dvw max-w-container-lg max-h-full my-auto bg-base-100 p-5 pb-0`} ref={wrapper}>
...

            {
              <div className="relative w-full h-full mt-10">
                ...
                <div className="w-full sticky bottom-0 bg-base-100 py-4">
                  {
                    status == 'edit' &&
                    <div className="btn btn-sm btn-accent w-full" onClick={e=> handleSubmit(log)}>등록</div>
                  }
                </div>
