...
import { CreateParams, UpdateParams } from '~/components/fields/FieldType';
...
class CategoryQuery {
  ...
  update= async ({params, id}: {params:UpdateParams, id: string})=> {
    console.log(params, id)
    const { data, access_token, idKey }= params
    // return
    const option: FastapiProps= { 
      operation: 'PUT', 
